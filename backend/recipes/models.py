...
class Recipe(models.Model):
    ...
    # Требуется ли перевод в name в capitalize? Переопределить def clean?
    # Требуется ли уменьшенная версия изображения? Переопределить def save?
